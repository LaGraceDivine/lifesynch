...
$query = "SELECT sleep_time, wake_time, duration, created_at FROM sleep_tracker WHERE user_id = '$userId' ORDER BY created_at DESC";
$result = mysqli_query($conn, $query);

if ($result) {
    $sleepHistory = mysqli_fetch_all($result, MYSQLI_ASSOC);
} else {
...
<body>
    ...
    <header>
        <h1>Your Sleep Track History</h1>
    </header>
